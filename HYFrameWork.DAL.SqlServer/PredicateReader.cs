    ...
    public class PredicateReader:ExpressionVisitor
    {
        ...
        private string BuildMethodSql(Expression obj, string methodName, object[] paras)
        {
            ...
            switch (methodName)
            {
                ...
                case "CharIndex":           return MethodSqlBuilder.CharIndex(paras[0].ToString(), paras[1].ToString());
                default:
                    throw new NotSupportedException("Unsupported expression type: Unknown method type ");
            }
        }
        #endregion
