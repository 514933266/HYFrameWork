...
namespace HYFrameWork.Image
{
    ...
    public class VerificationCode
    {
        ...
        private int _letterWidth = 24;  //单个字体的宽度范围
        private int _letterHeight = 24; //单个字体的高度范围
        private static byte[] _randb = new byte[4];
        private static RNGCryptoServiceProvider rand = new RNGCryptoServiceProvider();
        private Font[] fonts =
    {
       new Font(new FontFamily("Times New Roman"),14 +Next(2),System.Drawing.FontStyle.Regular),
       new Font(new FontFamily("Georgia"),14 + Next(2),System.Drawing.FontStyle.Regular),
       new Font(new FontFamily("Arial"), 14 + Next(2),System.Drawing.FontStyle.Regular),
       new Font(new FontFamily("Comic Sans MS"), 14 + Next(2),System.Drawing.FontStyle.Regular)
    };
        ...
        public VerificationCode(string text,int length=4)
        {
            _text = text;
            _letterCount = length;
        }
        ...
        {
            int int_ImageWidth = _text.Length * _letterWidth;
            Bitmap image = new Bitmap(int_ImageWidth, _letterHeight);
            ...
            g.DrawRectangle(new Pen(Color.LightGray, 1), 0, 0, int_ImageWidth - 1, (_letterHeight - 1));
            _image = image;
        }
